...
const translations = {
  sv: {
    ...
    "settings.sync.status.ok": "Senaste backup lyckades",
    "settings.sync.status.failed": "Senaste backup misslyckades",
    "settings.sync.status.running": "Kör just nu…",
    "settings.sync.status.never": "Har inte körts än",
    "settings.sync.log": "Logg",
    ...
    "settings.update.rebuilding": "Boxen hämtar uppdateringen och bygger om. Sidan laddas om automatiskt när den är klar.",
    "settings.update.timeout": "Det tar längre tid än väntat. Ladda om sidan om en stund för att se om uppdateringen är klar.",
    "settings.update.changelog": "Nyheter",
    "whatsnew.title": "Nyheter i",
    "whatsnew.subtitle": "Din box har uppdaterats. Här är vad som är nytt.",
    "whatsnew.dismiss": "Uppfattat",
    ...
    "settings.network": "Din box",
    "settings.network.ip": "Din IP",
    "settings.network.mdns": "Namn på nätverket",
    "settings.network.reachable": "Nås härifrån",
    "settings.network.unreachable": "Nås inte härifrån",
    "settings.network.checking": "Kontrollerar...",
    "settings.network.recheck": "Testa igen",
    "settings.network.hint": "Använd IP-adressen om namnet inte fungerar på den här enheten.",
  ...
  en: {
    ...
    "settings.sync.status.ok": "Last backup succeeded",
    "settings.sync.status.failed": "Last backup failed",
    "settings.sync.status.running": "Running now…",
    "settings.sync.status.never": "Not run yet",
    "settings.sync.log": "Log",
    ...
    "settings.update.rebuilding": "The box is fetching the update and rebuilding. This page reloads automatically when it's done.",
    "settings.update.timeout": "This is taking longer than expected. Reload the page in a minute to see if the update finished.",
    "settings.update.changelog": "What's new",
    "whatsnew.title": "What's new in",
    "whatsnew.subtitle": "Your box was updated. Here's what's new.",
    ...
    "settings.network": "Your box",
    "settings.network.ip": "Your IP",
    "settings.network.mdns": "Network name",
    "settings.network.reachable": "Reachable from here",
    "settings.network.unreachable": "Not reachable from here",
    "settings.network.checking": "Checking...",
    "settings.network.recheck": "Test again",
    "settings.network.hint": "Use the IP address if the name doesn't work on this device.",
