...
export const APP_DEFINITIONS: Record<AppName, AppDefinition> = {
  ...
  radarr: {
    name: "radarr",
    displayName: "Radarr",
    description: "Filmbibliotek automatiskt",
    containerName: "radarr",
    composeFile: "/opt/hemmaos/apps/radarr/docker-compose.yml",
    defaultPort: 7878,
    internalPort: 7878,
    proxyPath: "radarr",
    envFields: [],
  ...
  sonarr: {
    ...
    composeFile: "/opt/hemmaos/apps/sonarr/docker-compose.yml",
    defaultPort: 8989,
    internalPort: 8989,
    proxyPath: "sonarr",
    envFields: [],
  ...
  overseerr: {
    ...
    composeFile: "/opt/hemmaos/apps/overseerr/docker-compose.yml",
    defaultPort: 5055,
    internalPort: 5055,
    proxyPath: "overseerr",
    envFields: [],
  ...
  qbittorrent: {
    ...
    composeFile: "/opt/hemmaos/apps/qbittorrent/docker-compose.yml",
    defaultPort: 8082,
    internalPort: 8080,
    proxyPath: "qbittorrent",
    envFields: [],
  },
};
