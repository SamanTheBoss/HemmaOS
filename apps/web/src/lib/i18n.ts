...
const translations = {
  sv: {
    ...
    "apps.open": "Öppna",
    "apps.installing": "Home_OS konfigurerar din app...",
    ...
    "settings.reboot": "Starta om Home_OS",
    ...
    "auth.setup.title": "Välkommen till Home_OS",
  ...
  en: {
    ...
    "apps.open": "Open",
    "apps.installing": "Home_OS is configuring your app...",
    ...
    "settings.reboot": "Restart Home_OS",
    ...
    "auth.setup.title": "Welcome to Home_OS",
